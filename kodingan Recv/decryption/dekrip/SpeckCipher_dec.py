...
def print_en(mess, cipher_txt,block_size, key_size):
    print("Message\t\t: ",mess)
    print("Block Size\t: ", block_size)
    print("Key Size\t: ",key_size)
    print("Ciphertext\t: ", cipher_txt, "\n")
    print("Length\t\t: ", len(cipher_txt), "Bytes")
...
def pencatatan(r, mess,date_now, plaintxt, encryption_periode,block_size,key_size):
    f = open('Speck_dec.csv', 'a')
...
def decrypt_dt(cipher_txt,block_sizes,key_sizes):    
